    ...
    ColumnLayout {
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                ToolTip.visible: rowMouseArea.containsMouse && app.getConfig("enableTooltips")
                ToolTip.delay: 300
                ToolTip.text: type === "text" ? content : tr("image", "Image")
        ...
        RowLayout {
            ...
            Button {
                text: app && app.isWayland() ? tr("copy", "Copy") : tr("paste", "Paste")
                onClicked: {
                    if (!app) return
                    if (app.isWayland()) {
                        copySelectedItem()
                        ...
                        Flickable {
                            ...
                            ColumnLayout {
                                ...
                                ShortcutCapture {
                                    ...
                                    onShortcutChanged: if (configLoaded) app.setConfig("globalShortcut", newShortcut)
                                }
                                ...
                                ShortcutCapture {
                                    ...
                                    onShortcutChanged: if (configLoaded) app.setConfig("screenshotShortcut", newShortcut)
                                }
                            }
                        }
